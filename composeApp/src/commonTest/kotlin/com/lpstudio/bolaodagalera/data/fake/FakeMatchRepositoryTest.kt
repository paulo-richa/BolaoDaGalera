...
class FakeMatchRepositoryTest {
    ...
    @Test
    fun `getMatches should return list of matches`() =
        runTest {
    ...
    @Test
    fun `updateMatchScore should update scores and set isManual to true`() =
        runTest {
            val match =
                Match(
                    id = "M1",
    ...
    @Test
    fun `updateMatchTeams should update teams and set isManual to true`() =
        runTest {
            val match =
                Match(
                    id = "M2",
